    ...
    <div class="content-header">
      ...
      <div class="container-fluid mt-2">
        <div class="card p-2">
                    ...
                    <div class="card-body">
                        <form action="/admin/posts/update/<?=$posts['slug'] ;?>" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <br>
                                <textarea name="desc" class="form-control <?= ($validation->hasError('author')) ? 'is-invalid' : '' ;?>" id="desc" cols="15" rows="30">
